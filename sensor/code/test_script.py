...
def action_push(slave_id, machine_name, devStat):
    reading1=0
    reading2=0
    reading3=0
    reading4=0
    ...
    reading1 = register_read(current1, 4, slave_id)
    logger.info(f"I1: {reading1}")
    time.sleep(0.5)

    reading2 = register_read(voltage1, 4, slave_id)
    ...
    reading6 = register_read(current2, 4, slave_id)
    logger.info(f"I2: {reading6}")
    time.sleep(0.5)

    reading7 = register_read(voltage2, 4, slave_id)
    logger.info(f"V2: {reading7}")
    time.sleep(0.5)

    reading8 = register_read(current3, 4, slave_id)
    logger.info(f"I3: {reading8}")
    time.sleep(0.5)

    reading9 = register_read(voltage3, 4, slave_id)
...
while(1):
    if client.connect():  # Trying for connect to Modbus Server/Slave
        action_push(slave_id, machine_name,2)
